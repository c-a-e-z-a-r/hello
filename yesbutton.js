document.addEventListener("DOMContentLoaded", function () {
    ...
    if (yesButton) {
        ...
        yesButton.addEventListener("click", function () {
            ...
            button1Div.innerHTML = "<span class='love-text'>Yeheyy!!! <br> See you baby!!! </span>"
            ;
    
            // Replace NO button with a marquee message and gif
            button2Div.innerHTML = `
                <marquee behavior="scroll" direction="left" scrollamount="17" class="marquee-text">
                    You're my everything, as always and forever baby.
                </marquee>
